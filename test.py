...
# This looks for the file "housing.csv" in the same folder
df = pd.read_csv("housing.csv")

# Handling Missing Values
df = df.dropna()

# We separate the data: 'median_house_value' is what we want to predict (Target)
# Everything else is a feature (Square footage, bedrooms, etc.)
X = df.drop(columns=['median_house_value']) 
y = df['median_house_value']
# Convert the text column into numeric columns
